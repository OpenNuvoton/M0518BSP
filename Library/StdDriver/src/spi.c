 ...
 * $Revision: 3 $
 * $Date: 14/12/24 2:22p $
 * @brief    M0518 series SPI driver source file
 *
 * @note
 *
...
/**
  ...
  *          For example, if the SPI source clock rate is 12MHz and the target SPI bus clock rate is 7 MHz, the
...
/**
  ...
  * @param[in]  spi The pointer of the specified SPI module.
  * @return None
  * @details This function will clear SPI RX FIFO buffer. The RX_FULL flag will be cleared to 0 and the RX_EMPTY flag will be set to 1.
  *          The RX_CLR bit will be cleared to 0 by hardware after it is set to 1 by software.
  */
...
/**
  ...
  * @param[in]  spi The pointer of the specified SPI module.
  * @return None
  * @details This function will clear SPI TX FIFO buffer. The TX_FULL flag will be cleared to 0 and the TX_EMPTY flag will be set to 1.
  *          The TX_CLR bit will be cleared to 0 by hardware after it is set to 1 by software.
  */
...
/**
  ...
  * @param[in]  spi The pointer of the specified SPI module.
  * @param[in]  u32SSPinMask Specifies slave selection pins. (SPI_SS0)
...
/**
  ...
  *          For example, if the SPI source clock rate is 12MHz and the target SPI bus clock rate is 7 MHz, the actual SPI bus clock
  *          rate will be 6 MHz.
  * @note   If u32BusClock = 0, DIVIDER setting will be set to the maximum value.
  * @note   If u32BusClock >= system clock frequency, SPI peripheral clock source setting in CLKSEL1 register will be set to select
  *         HCLK. The DIVIDER (SPI_DIVIDER[7:0]) will be set to 0.
...
/*@}*/ /* end of group M0518_SPI_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M0518_SPI_Driver */
